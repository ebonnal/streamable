...
def complex_stream_str() -> str:
    ...
    .distinct(async_identity, consecutive=False)
    ...
    .group(up_to=100, by=None, interval=None)
    .group(up_to=100, by=async_identity, interval=None)
    .groupby(len, up_to=None, interval=None)
    .groupby(async_identity, up_to=None, interval=None)
