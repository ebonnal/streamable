...
class _GroupByEveryIterable(Iterable[Union[ExceptionContainer, Tuple[U, List[T]]]]):
    __slots__ = (
        "iterator",
        "up_to",
        "by",
...
class GroupByEveryIterator(RaisingIterator[Tuple[U, List[T]]]):
    def __init__(
        self,
        iterator: Iterator[T],
        up_to: Optional[int],
        ...
        super().__init__(iter(_GroupByEveryIterable(iterator, up_to, by, every)))
